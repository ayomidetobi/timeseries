...
from app.api.v1.endpoints import meta_series, value_data, lookup_tables, dependencies, system

api_router = APIRouter()

api_router.include_router(system.router, tags=["system"])
api_router.include_router(meta_series.router, prefix="/meta-series", tags=["meta-series"])
