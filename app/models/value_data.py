...
class valueData(Base):
    ...
    series_id: Column = Column(types.UInt32, primary_key=True)            # FK to metaSeries.series_id
    timestamp: Column = Column(types.DateTime64(6), primary_key=True)    # high precision timestamp
